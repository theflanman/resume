...
%
 ...
 Python \textbullet{} C/C++ \textbullet{} Matlab \textbullet{} Lua \\ 
 Java \textbullet{} JavaScript \textbullet{} HTML \textbullet{} CSS \\
 Labview \textbullet{} C\# \textbullet{} Rust
 ...
 \location{Python:}
 NumPy \textbullet{} SciPy \textbullet{} Pandas \textbullet{} PyTest \\
TensorFlow \textbullet{} ROS (1 and 2) \\

 \location{Matlab:}
 Signal Processing \textbullet{} Compiler \textbullet{} MEX

 \subsection{Analysis}
 Signals Processing \textbullet{} Spectral Analysis \\
Fourier Analysis \textbullet{} Circuits Design \\
Software Profiling
...
\sectionspace % Some whitespace after the section
\begin{tightitemize}
\item Implemented a simulation of a kilowatt-scale stirling engine in C; used power output as the objective function for gradient ascent algorithm.  Reduced computational time from ~60 hours to 20 minutes.
\item Developed a Python library to classify vocalizations using spectral analysis, image recognition methods, and bayesian estimation implemented with Numpy, SciPy, Scikit-Learn, and Tensorflow.
...
\item Built a tool to optimize a parametric aerofoil design in a non-linear design space using Matlab.   
% Built DeMCAS, a tool to optimize parametric aerofoil designs in Matlab.  This primarily utilized a gradient descent method to reach an optimal solution.
...
\item Wrote SBIR proposals focussing on spectrographic signal analysis, machine learning, and condition-based maintenance.
\item Developer for Midé's open source Python libraries, which are used to analyze shock and vibration data.
\item Developed C extensions for Python which utilize SIMD instruction sets (SSE/AVX2) to outperform numpy and scipy functions.
\end{tightitemize}
...
\item Designed experiments utilizing high speed cameras and machine vision to identify errors in automated immuno-assay tests.
\end{tightitemize}
...
\begin{tightitemize}
\item Designed lab assignments for WPI's mobile robotics course, in order to create a more coherent experience for students.  Students are introduced to ROS and Turtlebots in week 1, and program the robot to explore an unknown environment for the final project at week 7.
\end{tightitemize}
...
\runsubsection{Midé Technology}
\descript{| \underline{BISCEP} \href{https://www.sbir.gov/node/1159583}{(Phase I)} \href{https://www.sbir.gov/node/14749939}{(Phase II)}}
\location{December 2017 - March 2020}
BISCEP is a prototype of a man-portable stirling engine, designed to provide power in remote location from any burnable fuel.  My involvment in both phases focused on developing the kinematics, characterizing the behavior of the electric generator, and implementing the simulation with optimization routines.  The simulation itself was implemented as a native C program which utilized Intel's SIMD instructions to substantially accelerate processing speed; optimization was done with Matlab's Optimization Toolbox.
...
RASP is a Python audio processing library which utilizes Numpy, SciPy, Scikit-Learn, and Tensorflow.  The first phase of the contract was largely self-directed, and required me to refine my skills in signal processing and image analysis.  In phase II, I lead a small team to refine the system with a few methods, namely bayesian estimation and recurrent neural networks.
